...
written in 2020.4.13, revised in 2022.12.6
By Zhiyuan You
"""
    ...
    for i_ms in range(num_star):
        ...
        if lines_out:
            ...
            if visualization:
                ...
                print(f"Successfully generated txt file for {CN_ms}")
...
def simulate_one_star(lines, i_ms, para_simu):
    ...
    x_ms = y_ms = 0
    lines_out.append(f"{CN_ms} {VM_ms} {x_ms} {y_ms}\n")
    ...
    for i_ns in range(num_star):
        ...
        if AD_ms_ns < para_simu.FOV_max:
            ...
            if abs(x_ns) > para_simu.N_x // 2 or abs(y_ns) > para_simu.N_y // 2:
                ...
                lines_out.append(f"{CN_ns} {VM_ns} {x_ns} {y_ns}\n")
